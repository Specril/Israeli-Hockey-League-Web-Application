    ...
    const onSubmit = async (e) => {
        if (!isRegistering) {
            ...
            try {
                ...
                // Use onAuthStateChanged to wait for the user profile to be fully loaded
                const unsubscribe = onAuthStateChanged(auth, (updatedUser) => {
                    if (updatedUser && updatedUser.displayName === name) {
                        setCurrentUser(updatedUser); // Update the current user in context
                        navigate('/home'); // Navigate to home after user profile is fully loaded
                        unsubscribe(); // Unsubscribe to prevent multiple navigations
